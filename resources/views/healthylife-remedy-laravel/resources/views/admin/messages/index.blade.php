...
<div class="d-flex gap-2 mb-4">
  <a href="#" class="admin-filter-pill active">All <span class="ms-1">{{ count($messages) }}</span></a>
  <a href="#" class="admin-filter-pill">Unread <span class="ms-1">{{ collect($messages)->where('read', false)->count() }}</span></a>
  <a href="#" class="admin-filter-pill">Contact Form</a>
  <a href="#" class="admin-filter-pill">Advertising</a>
</div>

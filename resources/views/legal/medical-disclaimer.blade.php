...
<section class="page-hero-light">
  <div class="container">
    ...
    <p>Please read this disclaimer carefully before using information from this site.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 article-body-v2">
        ...
        <h2>Emergencies</h2>
        <p>If you are experiencing a medical emergency, call your local emergency number immediately. Do not rely on information found on this website in an emergency situation.</p>

        <h2>No Guarantees</h2>
        <p>While our content is reviewed against available research and clinical guidelines, individual results vary, and we make no guarantees about outcomes from following any information published on this site.</p>

        <h2>External Links and Products</h2>
        <p>Mentions of specific supplements, products, or external resources are for informational purposes and do not constitute an endorsement or guarantee of safety or effectiveness for any individual.</p>
      </div>
    </div>
  </div>
</main>
